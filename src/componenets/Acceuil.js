...
if(navigate1.state === "Loading" ){<h1>Loading</h1>};
  ...
  return (
    <div className='Acceuil' >
      ...
      <li> Page de contact sur un site de services :<a href=' https://www.exempleservices.com/contact-us'> https://www.exempleservices.com/contact-us</a></li><br></br>
